...
<body>
 <body id="mimin" class="dashboard">
          <!-- start: Content -->
          <div id="content" class="search-v1" style="margin-top: 0px; padding-left: 0px;">
            <div class="panel" style="width: 100%;">
              <div class="panel-body">
                 <ul id="tabs-demo6" class="nav nav-tabs nav-tabs-v6 masonry-tabs" role="tablist">
                    <li role="presentation" class="active">
                      <a href="#tabs-demo7-area1" id="tabs-demo6-1" role="tab" data-toggle="tab" aria-expanded="true">Chat Content</a>
                    </li>
                    <li role="presentation" class="">
                      <a href="#tabs-demo7-area2" role="tab" id="tabs-demo6-2" data-toggle="tab" aria-expanded="false">Member</a>
                    </li>
                  </ul>
              </div>
            </div>
                  ...
                  <div id="tabsDemo6Content" class="tab-content tab-content-v6 col-md-12">
                    <div role="tabpanel" class="tab-pane search-v1-menu1 fade active in" id="tabs-demo7-area1" aria-labelledby="tabs-demo7-area1">
                      <div class="col-md-6 padding-0">
							...
							<%-- <p>${book.memNum} ${book.content}</p> --%>
                          	
                          	<div class="media">
                            <div class="media-left"><%-- ${book.memNum} --%></div>
                            <div class="media-body">
                              <a class="media-heading"> ${book.content} </a>
								<p> ${book.content}</p>
                            </div>
                          	</div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tabs-demo7-area2" aria-labelledby="tabs-demo7-area2">
                          <div class="media">
                                <div class="media-left">
                                  <a href="#">
                                    <img src="resources/asset/img/avatar2.png" class="media-object search-v1-avatar"/>
                                  </a>
                                </div>
                                <div class="media-body">
                          ...
                          <div class="media">
                                <div class="media-left">
                                  <a href="#">
                                    <img src="resources/asset/img/avatar.jpg" class="media-object search-v1-avatar"/>
                                  </a>
                                </div>
                                <div class="media-body">
                                  <h4 class="media-heading">Fulan</h4>
                          ...
                          <div class="media">
                                <div class="media-left">
                                  <a href="#">
                                    <img src="resources/asset/img/avatar3.png" class="media-object search-v1-avatar"/>
                                  </a>
                                </div>
                                <div class="media-body">
                    ...
                    <div role="tabpanel" class="tab-pane fade col-md-12 padding-0" id="tabs-demo7-area3" aria-labelledby="tabs-demo7-area3">
                          <div class="row masonry-container">
                            <div class="col-md-4 col-sm-6 col-xs-12 item">
                              <div class="thumbnail">
                                <img class="img-responsive" src="resources/holder.js/400x400" alt="">
                              </div>
                            </div><!--/.item  -->

                            <div class="col-md-4 col-sm-6 col-xs-12 item">
                              <div class="thumbnail">
                              <img class="img-responsive" src="holder.js/400x500" alt="">
                              </div>
                            </div><!--/.item  -->

                            <div class="col-md-4 col-sm-6 col-xs-12 item">
                              <div class="thumbnail">
                              <img class="img-responsive" src="holder.js/400x250" alt="">
                              </div>
                            </div><!--/.item  -->
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 item">
                              <div class="thumbnail">
                              <img class="img-responsive" src="holder.js/400x600" alt="">
                              </div>
                            </div><!--/.item  -->

                            <div class="col-md-4 col-sm-6 col-xs-12 item">
                              <div class="thumbnail">
                              <img class="img-responsive" src="holder.js/400x450" alt="">
                              </div>
                            </div>
                ...
                <div id="right-menu-user" class="tab-pane fade in active">
                  ...
                  <div class="user col-md-12">
                   <ul class="nav nav-list">
                    <li class="online">
                      <img src="resources/asset/img/avatar.jpg" alt="user name">
                      <div class="name">
                        ...
                        <div class="row msg_container send">
                          <div class="col-md-9 col-xs-9 bubble">
                            ...
                            <div class="col-md-3 col-xs-3 avatar">
                              <img src="resources/asset/img/avatar.jpg" class=" img-responsive " alt="user name">
                            </div>
                          </div>
                                ...
                                <ul>
                                  <li class="online">
                                    <a href=""  data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                                      <div class="user-avatar"><img src="resources/asset/img/avatar.jpg" alt="user name"></div>
                                      <div class="dot"></div>
                                    </a>
                                  </li>
                                  <li class="offline">
...
<!-- plugins -->
<script src="resources/asset/js/plugins/imagesloaded.pkgd.min.js"></script>
<script src="resources/asset/js/plugins/masonry.pkgd.min.js"></script>
<script src="resources/asset/js/plugins/holder.min.js"></script>
