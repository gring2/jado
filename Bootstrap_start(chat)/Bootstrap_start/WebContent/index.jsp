          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>Eunah Kong</span></li>
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple"><a href="calendar.html"><span class="fa fa-folder-o"></span> Clip  </a></li>
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-table"></span> 	GanttChart  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
                        <li><a href="datatables.html">Data Tables</a></li>
                        <li><a href="handsontable.html">handsontable</a></li>
                        <li><a href="tablestatic.html">Static</a></li>
                    ...
                    <li class="ripple"><a href="calendar.html"><span class="fa fa-folder"></span> Storage  </a></li>
                  </ul>
                </div>
            </div>
          <!-- end: Left Menu -->
                ...
                <div class="col-md-12" style="padding:20px;">
                   <div class="col-md-12 padding-0">
                        <div class="col-md-8 padding-0">
                           <iframe name="center" id="center" src="chatbox.jsp" style="width: 100% ; height: 1000px; border: 1px, solid, black;">
                           </iframe>
                        </div>
                        
                      	<div class="col-md-4" style="border: 1px, solid, black; width: 30% ; height: 850px;">
                            <iframe name="right_up" width="100%" height="60%" src="" style="border: 1px, solid, black;" >
                            </iframe>

							<iframe name="right_down" width="100%" height="40%" src="" style="border: 1px, solid, black;" >
                            </iframe>
	                    </div>
                    </div>
                </div>
