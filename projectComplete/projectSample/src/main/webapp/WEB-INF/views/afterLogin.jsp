...
$(function() {
	...
	$("#prompt").on( 'click', function () {
		reset();
		alertify.prompt("Please input your project name", function (e, str) {
			if (e) {
				alertify.success("You've clicked OK and typed: " + str);
				var usrNum = $('#usrNum').val();
				alert(typeof usrNum)
				location.href="insertProject?title="+str+"&userNum="+usrNum;
			} else {
...
<![endif]-->
 ...
 <body id="mimin" class="dashboard">
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="icons icon-user">
                    </span> Account Setting  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                    	<ul class="nav nav-list tree">
                        <li><a href="loginView">SignIn</a></li>
                        <li><a href="joinView">SignUp</a></li>
                        <li><a href="logout">SignOut</a></li>
                       </ul>
                    </li>
                    <li class="ripple"><a href="#"><span class="fa fa-folder-o"></span> Clip  <span class="fa-angle-right fa right-arrow text-right"></span></a></li>
                    <li class="ripple"><a href="#"><span class="icons icon-list"></span> Project List  <span class="fa-angle-right fa right-arrow text-right"></span></a></li>
                  </ul>
                </div>
            </div>
          <!-- end: Left Menu -->
          ...
          <!-- start: content -->
            <div id="content">
                <div class="col-md-12" style="padding:20px;">
                  <div class="panel col-md-12 padding-0" style="width: 70%">
                      <div class="panel-heading txtcenter">
                        <h3>Project List</h3>
                      </div>
                      <c:forEach var="list" items="${pList }">
	                      <div class="panel-body txtcenter">
	                          ...
	                          <form action="gotoGroup" id='goto' method="get">
	                          	<h4><a href="#" class="goto">${list.title }</a></h4>
	                          	<input type="text" name="proNum", value="${list.proNum}">
	                          </form>
	                          	<h5>${loginName }</h5>
	                          </div>
	                      </div>
                      </c:forEach>
                      <div class="panel-body txtcenter" style="padding-bottom: 0px; padding-top: 0px;">    
                          <hr />
                      </div>
                      <div class="panel-body txtcenter" style="padding-top: 0px;">
                          <h4><a href="#" id="prompt">+ 새로운 프로젝트 생성하기</a	></h4>
                      </div>
                  </div>
                  <!-- iframe -->
                      <div class="col-md-4" style="border: 1px, solid, black; width: 30% ; height: 850px; position: right; right: 0;">
	                       <iframe name="right_up" width="100%" height="60%" src="zombie?usr=${sessionScope.loginName }" style="border: 1px, solid, black;" >
							...
							<iframe name="right_down" width="100%" height="40%" src="sticky" style="border: 1px, solid, black;" >
	                       </iframe>
	                    </div>
      ...
      <button id="mimin-mobile-menu-opener" class="animated rubberBand btn btn-circle btn-danger">
       ...
       <!-- end: Mobile -->
	<input type="hidden" value="${userNum}" id='usrNum'>
    <!-- start: Javascript -->
